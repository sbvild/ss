...
namespace ss
{
	...
	public class ConsoleLog : Log{
		...
		public string[] GetErrorStringList(){
			if(!isError)
				return new string[0];
			Init();
			Copy();
	...
	public class SearchWord{
        ...
        public void RestoreState()
        {
            ...
            SearchWord tmp = (SearchWord)serializer2.Deserialize(fs2);
            fs2.Close();

            this.m_blackList = tmp.m_blackList;
            this.m_whiteList = tmp.m_whiteList;
        }
	}
}
