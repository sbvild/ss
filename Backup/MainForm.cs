...
namespace ss
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        public MainForm()
        {
			...
			_serverList1 = new Server[1];
			_serverList1[0] = new Server();
			_searchWord = new SearchWord();
			_searchWord.BlackList.Add("異常：");
			_searchWord.BlackList.Add("エラー");
			_searchWord.WhiteList.Add("異常：マスタ更新");
